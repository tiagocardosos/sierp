Ext.define('Ux.CnpjField', {
   ...
   formatCNPJ: function(k) {
      ...
      var a = h.length;
      if (d == "" && a > 0 && j == <img src="http://www.loiane.com/wp-includes/images/smilies/icon_cool.gif" alt="8)" class="wp-smiley"> {
         a--;
         h = h.substr(0, a);
         k.stopEvent();
      }
   ...
   testaCNPJ: function(a, d) {
      ...
      for (f = d; f > 0; f--) {
         ...
         if (e > <img src="http://www.loiane.com/wp-includes/images/smilies/icon_cool.gif" alt="8)" class="wp-smiley"> {
            e = 2;
         } else {
            e++;
         }
